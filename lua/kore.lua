...
local function get_colors()
  ...
  local color_groups = {
    dark = {
      ...
      red_dark = p.red_light,
      green_dark = p.green_light,
      yellow_dark = p.yellow_light,
      blue_dark = p.blue_light,
      pink_dark = p.pink_light,
      cyan_dark = p.cyan_light,
      orange_light = p.orange_light,
      gray = p.gray,
    }
  }
...
local function get_groups()
  ...
  local groups = {
    ...
    WinSeparator = config.transparent_mode and { fg = colors.bg3, bg = nil } or { fg = colors.bg3, bg = colors.background },
    WildMenu = { fg = colors.blue_normal, bg = colors.dark_light, bold = config.bold },
    Directory = { link = "KoreGreenBold" },
    Title = { link = "KoreGreenBold" },
    ErrorMsg = { fg = colors.background, bg = colors.red_normal, bold = config.bold },
    ...
    Comment = { fg = colors.light_dark },
    Todo = { fg = colors.background, bg = colors.yellow_normal, bold = config.bold, italic = config.italic.comments },
