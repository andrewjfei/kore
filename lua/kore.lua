...
local function get_groups()
  ...
  local groups = {
    ...
    WarningUnderline = { fg = colors.yellow, underline = true, sp = colors.orange },
    InfoUnderline = { fg = colors.cyan, underline = true, sp = colors.cyan },
    HintUnderline = { fg = colors.pink, underline = true, sp = colors.yellow },
    ...
    Removed = { link = "Error" },
    Changed = { link = "Info" },
    DiffDelete = { link = "Colour7Background2Bold" },
    DiffAdd = { link = "Colour2Background2Bold" },
    DiffChange = { link = "Colour6Background2Bold" },
    DiffText = { link = "Colour4Background2Bold" },
