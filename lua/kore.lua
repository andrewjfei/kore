...
local function get_groups()
  ...
  local groups = {
    ...
    DiagnosticFloatingError = { link = "Colour7" },
    DiagnosticFloatingWarn = { link = "Colour3" },
    DiagnosticFloatingInfo = { link = "Colour6" },
    DiagnosticFloatingHint = { link = "Colour4" },
    DiagnosticVirtualTextError = { link = "Colour7" },
    DiagnosticVirtualTextWarn = { link = "Colour3" },
    DiagnosticVirtualTextInfo = { link = "Colour6" },
    DiagnosticVirtualTextHint = { link = "Colour4" },
    DiagnosticOk = { link = "Colour2" },
