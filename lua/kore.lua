...
local function get_groups()
  ...
  local groups = {
    ...
    DiffDelete = { fg = colors.dark_light, bg = colors.red_dark, bold = true },
    DiffAdd = { fg = colors.dark_light, bg = colors.green_dark, bold = true },
    DiffChange = { fg = colors.dark_light, bg = colors.cyan_dark, bold = true },
    DiffText = { fg = colors.dark_light, bg = colors.orange_normal, bold = true },
