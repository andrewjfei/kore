...
local function get_groups()
  ...
  local groups = {
    ...
    Colour2Background2Bold = { fg = colors.background_alt, bg = colors.green, bold = true },
    ...
    WarningUnderline = { fg = colors.orange, underline = true, sp = colors.orange },
    InfoUnderline = { fg = colors.cyan, underline = true, sp = colors.cyan },
    HintUnderline = { fg = colors.yellow, underline = true, sp = colors.yellow },
    ...
    WinBar = { fg = colors.green, bg = colors.pink },
    WinBarNC = { fg = colors.blue, bg = colors.red },
    ...
    Removed = { link = "Error" },
    Changed = { link = "Info" },
    DiffDelete = { link = "Error" },
    DiffAdd = { link = "Ok" },
    DiffChange = { link = "Info" },
    DiffText = { link = "Hint" },
    ...
    CmpItemKindText = { link = "Foreground1" },
    -- CmpItemKindVariable = { link = "KoreOrange" },
    CmpItemKindMethod = { link = "Colour2" },
    CmpItemKindFunction = { link = "Colour2" },
    -- CmpItemKindConstructor = { link = "KoreYellow" },
    -- CmpItemKindUnit = { link = "KoreBlue" },
    CmpItemKindField = { link = "Colour1" },
    CmpItemKindClass = { link = "Colour4" },
    CmpItemKindInterface = { link = "Colour4" },
    ...
    CmpItemKindSnippet = { link = "Colour3" },
    CmpItemKindFile = { link = "Foreground1" },
    CmpItemKindFolder = { link = "Colour2" },
    ...
    -- lualine
    lualine_a_normal = { fg = colors.background_alt, bg = colors.foreground_alt2 },
    lualine_b_normal = { fg = colors.foreground_alt, bg = colors.background_alt2 },
    lualine_c_normal = { fg = colors.foreground_alt2, bg = colors.background_alt },
    lualine_a_visual = { link = "lualine_a_normal" },
    lualine_b_visual = { fg = colors.background_alt, bg = colors.orange, bold = true },
    lualine_c_visual = { link = "Colour6Background2Bold" },
    lualine_a_replace = { link = "lualine_a_normal" },
    lualine_b_replace = { fg = colors.background_alt, bg = colors.red, bold = true },
    lualine_c_replace = { link = "Colour6Background2Bold" },
    lualine_a_insert = { link = "lualine_a_normal" },
    lualine_b_insert = { fg = colors.background_alt, bg = colors.cyan, bold = true },
    lualine_c_insert = { link = "Colour6Background2Bold" },
    lualine_a_command = { link = "lualine_a_normal" },
    lualine_b_command = { fg = colors.background_alt, bg = colors.green, bold = true },
    lualine_c_command = { link = "Colour6Background2Bold" },
