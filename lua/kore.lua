...
local function get_groups()
  ...
  local groups = {
    ...
    MatchParen = { bg = colors.dark_normal, bold = config.bold },
    ...
    Boolean = { link = "KoreForeground" },
    Number = { link = "KoreForeground" },
    Float = { link = "KoreForground" },
    ...
    javaScriptFunction = { link = "KoreCyan" },
