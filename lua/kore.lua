...
local function get_groups()
  ...
  local groups = {
    ...
    MatchParen = { fg = colors.background, bg = colors.orange_dark, bold = config.bold },
    ...
    Search = { fg = colors.background, bg = colors.yellow_normal, bold = true },
    IncSearch = { fg = colors.background, bg = colors.orange_normal, bold = true },
    ...
    FoldColumn = { fg = colors.yellow_normal, bg = colors.light_normal },
    ...
    DiffText = { fg = colors.light_normal, bg = colors.yellow_normal, bold = true },
