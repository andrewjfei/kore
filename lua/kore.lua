...
Kore.palette = {
  ...
  dark4 = "#f2613f", -- to remove orange   

  light_dark = "#747474",
  light_normal = "#b4b4b4",
  light_light = "#e4e4e4",
  light3 = "#ff0000", -- to remove red
  light4 = "#00ff00", -- to remove green
...
local function get_groups()
  ...
  local groups = {
    ...
    htmlBold = { fg = colors.fg0, bg = colors.background, bold = config.bold },
    htmlBoldUnderline = { fg = colors.fg0, bg = colors.background, bold = config.bold, underline = config.underline },
    htmlBoldItalic = { fg = colors.fg0, bg = colors.background, bold = config.bold, italic = true },
    ...
    htmlUnderline = { fg = colors.fg0, bg = colors.background, underline = config.underline },
    htmlUnderlineItalic = {
      fg = colors.fg0,
      bg = colors.background,
      italic = true,
    ...
    htmlItalic = { fg = colors.fg0, bg = colors.background, italic = true },
