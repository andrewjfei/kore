...
local function get_groups()
  ...
  local groups = {
    ...
    KoreRedUnderline = { undercurl = config.undercurl, sp = colors.red_dark },
    KoreGreenUnderline = { undercurl = config.undercurl, sp = colors.green_dark },
    KoreYellowUnderline = { undercurl = config.undercurl, sp = colors.yellow_dark },
    KoreBlueUnderline = { undercurl = config.undercurl, sp = colors.blue_dark },
    KorePinkUnderline = { undercurl = config.undercurl, sp = colors.pink_dark },
    KoreCyanUnderline = { undercurl = config.undercurl, sp = colors.cyan_dark },
    KoreOrangeUnderline = { undercurl = config.undercurl, sp = colors.orange_dark },
    ...
    MatchParen = { fg = colors.background, bg = colors.orange_light, bold = config.bold },
    ...
    Folded = { fg = colors.gray, bg = colors.dark_normal, italic = config.italic.folds },
    FoldColumn = config.transparent_mode and { fg = colors.gray, bg = nil } or { fg = colors.gray, bg = colors.dark_normal },
    ...
    Todo = { fg = colors.pink_normal, bg = colors.yellow_normal, bold = config.bold }, -- todo text in comments
    Done = { fg = colors.orange_normal, bold = config.bold, italic = config.italic.comments },
    Error = { fg = colors.red_normal, bold = config.bold, reverse = config.inverse },
    ...
    DiffDelete = { fg = colors.background, bg = colors.red_dark, bold = true },
    DiffAdd = { fg = colors.background, bg = colors.green_dark, bold = true },
    DiffChange = { fg = colors.background, bg = colors.cyan_dark, bold = true },
    DiffText = { fg = colors.background, bg = colors.yellow_normal, bold = true },
