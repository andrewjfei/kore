...
local function get_groups()
  ...
  local groups = {
    ...
    DiffDelete = { fg = colors.foreground, bg = colors.red_dark, bold = true },
    DiffAdd = { fg = colors.foreground, bg = colors.green_dark, bold = true },
    DiffChange = { fg = colors.foreground, bg = colors.cyan_dark, bold = true },
    DiffText = { fg = colors.foreground, bg = colors.orange_normal, bold = true },
