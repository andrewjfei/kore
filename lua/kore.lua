...
Kore.palette = {
  ...
  dark4 = "#f2613f", -- to remove orange_normal   
...
local function get_groups()
  ...
  local groups = {
    ...
    KorePurple = { fg = colors.pink_normal },
    KorePurpleBold = { fg = colors.pink_normal, bold = config.bold },
    KoreAqua = { fg = colors.cyan_normal },
    KoreAquaBold = { fg = colors.cyan_normal, bold = config.bold },
    ...
    KoreRedSign = config.transparent_mode and { fg = colors.red_normal, reverse = config.invert_signs }
      or { fg = colors.red_normal, bg = colors.bg1, reverse = config.invert_signs },
    KoreGreenSign = config.transparent_mode and { fg = colors.green_normal, reverse = config.invert_signs }
      or { fg = colors.green_normal, bg = colors.bg1, reverse = config.invert_signs },
    KoreYellowSign = config.transparent_mode and { fg = colors.yellow_normal, reverse = config.invert_signs }
      or { fg = colors.yellow_normal, bg = colors.bg1, reverse = config.invert_signs },
    KoreBlueSign = config.transparent_mode and { fg = colors.blue_normal, reverse = config.invert_signs }
      or { fg = colors.blue_normal, bg = colors.bg1, reverse = config.invert_signs },
    KorePurpleSign = config.transparent_mode and { fg = colors.pink_normal, reverse = config.invert_signs }
      or { fg = colors.pink_normal, bg = colors.bg1, reverse = config.invert_signs },
    KoreAquaSign = config.transparent_mode and { fg = colors.cyan_normal, reverse = config.invert_signs }
      or { fg = colors.cyan_normal, bg = colors.bg1, reverse = config.invert_signs },
    KoreOrangeSign = config.transparent_mode and { fg = colors.orange_normal, reverse = config.invert_signs }
      or { fg = colors.orange_normal, bg = colors.bg1, reverse = config.invert_signs },
    ...
    KorePurpleUnderline = { undercurl = config.undercurl, sp = colors.pink_normal },
    KoreAquaUnderline = { undercurl = config.undercurl, sp = colors.cyan_normal },
    KoreOrangeUnderline = { undercurl = config.undercurl, sp = colors.orange_normal },
    Normal = { fg = colors.foreground, bg = colors.background },
    NormalFloat = config.transparent_mode and { fg = colors.foreground, bg = nil } or { fg = colors.foreground, bg = colors.bg1 },
    NormalNC = config.dim_inactive and { fg = colors.gray, bg = colors.bg1 } or { link = "Normal" },
    CursorLine = { bg = colors.bg1 },
    CursorColumn = { link = "CursorLine" },
    TabLineFill = { fg = colors.bg4, bg = colors.bg1, reverse = config.invert_tabline },
    TabLineSel = { fg = colors.green_normal, bg = colors.bg1, reverse = config.invert_tabline },
    TabLine = { link = "TabLineFill" },
    MatchParen = { bg = colors.bg3, bold = config.bold },
    ColorColumn = { bg = colors.bg1 },
    Conceal = { fg = colors.blue_normal },
    CursorLineNr = { fg = colors.yellow_normal, bg = colors.bg1 },
    ...
    StatusLine = { fg = colors.bg2, bg = colors.foreground, reverse = config.inverse },
    ...
    WildMenu = { fg = colors.blue_normal, bg = colors.bg2, bold = config.bold },
    ...
    Operator = { fg = colors.orange_normal, italic = config.italic.operators },
    ...
    Pmenu = { fg = colors.foreground, bg = colors.bg2 },
    PmenuSel = { fg = colors.bg2, bg = colors.blue_normal, bold = config.bold },
    ...
    DapBreakpointSymbol = { fg = colors.red_normal, bg = colors.bg1 },
    DapStoppedSymbol = { fg = colors.green_normal, bg = colors.bg1 },
    ...
    DapUIPlayPause = { fg = colors.green_normal, bg = colors.bg1 },
    DapUIRestart = { fg = colors.green_normal, bg = colors.bg1 },
    DapUIScope = { link = "KoreBlue" },
    DapUISource = { link = "KoreFg1" },
    DapUIStepBack = { fg = colors.blue_normal, bg = colors.bg1 },
    DapUIStepInto = { fg = colors.blue_normal, bg = colors.bg1 },
    DapUIStepOut = { fg = colors.blue_normal, bg = colors.bg1 },
    DapUIStepOver = { fg = colors.blue_normal, bg = colors.bg1 },
    DapUIStop = { fg = colors.red_normal, bg = colors.bg1 },
    ...
    MiniAnimateNormalFloat = { fg = colors.foreground, bg = colors.bg1 },
    ...
    MiniTablineCurrent = { fg = colors.green_normal, bg = colors.bg1, bold = config.bold, reverse = config.invert_tabline },
    ...
    MiniTablineModifiedVisible = { fg = colors.bg1, bg = colors.foreground, reverse = config.invert_tabline },
    MiniTablineTabpagesection = { link = "Search" },
    MiniTablineVisible = { fg = colors.foreground, bg = colors.bg1, reverse = config.invert_tabline },
